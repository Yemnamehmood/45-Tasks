...
//question 5
let personname : string= "A person who never made a mistake never tried anything new.";
...
//question 11
let members: string[]=[`maham`,`Aamash`,`laraib`,`ahmed`];
for(let i=0; i<members.length; i++){
    console.log(members);
}

//question 12
let members1: string[]= [`maham`,`Aamash`,`laraib`,`ahmed`];
let message2: string= `How are you doing?`
for(let i=0; i<members1.length; i++){
    console.log(message2+members1[i]);
}

//question 13
let transportation: string[]= [`Honda city`,`Audi A3`,`Toyota Fortuner`,];
for(let i=0; i<transportation.length; i++){
    console.log(`I Would like to own a    `+ transportation[i]);
}

//question 14
let guestlist: string[]=[`Maham`,`Aamash`,`Ahmed`,`Haider`];
for(let i=0; i<guestlist.length; i++){
    console.log(`Dear` + guestlist[i] +  `\nI would like to invite you for tomorrow dinner` );
}

//question 15
let guestlist1: string[]=[`Maham`,`Aamash`,`Ahmed`,`Haider`];
for(let i=0; i<guestlist1.length; i++){
    console.log(`Dear`   + guestlist1[i]  +  `\nI would like to invite you for tomorrow dinner. \n\nThankyou\n`);
}
let notpresent: string = `Ahmed`;
...
//question 18
//task1
let places: string[]=[`maldives `, `Austrailia `, `Bali `, `Greece `, `Dubai `];
...
//question 19
let invitations:string[]=["Maham","Asmash"];
...
//question 20
let languages: string[]=["Urdu","Punjabi","English", "Sindhi"];
console.log("List of Languages");
console.log(languages);


// question 21
let book: {name:string, genre:string, price:number} = {name:"The Exorcist", genre:"Horror", price:400};
console.log(book);
...
let name2: string = "Yemna Mehmood"
let name3: string = "Yemna Mehmood Chohaan"
...
//question 30
let users: string[]=["admin", "eric", "ayan","amna"]
...
//question 31
let users1 : string []=["admin", "eric", "ayan", "amna"]
if (users1.length ===0) {
...
//question 32
let currentusers : string[]=["admin", "eric", "ayan", "haider","rina"];
let newusers : string[]=["admin", "eric", "rayan", "azhan","shayan"];

let currentusers_lower : string[] = currentusers.map(user3 => user3.toLowerCase())
...
let numbers : number []=[1,2,3,4,5,6,7,8,9,];
 ...
 //question 34
 let favouritePizza : string[]=["chickentikka","chickenfajita","cheesy"];
...
const magicians4: string[] = ["Yums", "Harry","David","Ricky"];
const greatmagicians2: string[] = make_great2(magicians4);
